...
function useFieldComponentContext() {
  ...
  if (typeof idContext !== "string") {
    throw new Error("Form components should be used within <form.AppField>")
  }
...
function Field({
  ...
  return (
    <IdContext.Provider value={id}>
      <scn.Field data-invalid={hasError} className={className} {...props} />
    </IdContext.Provider>
  )
}
...
function FieldDescription({
  ...
  return (
    <scn.FieldDescription id={formDescriptionId} className={className} {...props} />
  )
}
