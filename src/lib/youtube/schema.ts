...
export const videoMetadataSchema = z.object({
  ...
  description: z
    ...
    .optional(),
  tags: z.array(z.string().max(500, "Each tag must be less than 500 characters")).max(500, "Maximum 500 tags allowed").optional(),
...
export const aiAnalysisSchema = z.object({
  ...
  tags: z.array(z.string()).describe("Relevant tags for the video (max 500 tags)"),
